...
ejercicio_musculo('Flexiones de caderas en máquinas', isquios).
...
ejercicio_musculo('Sentadilla Búlgara', cuadriceps).
ejercicio_musculo('Elevaciones de Talones Unilaterales', gemelos).
ejercicio_musculo('Salto Tijera', gemelos).
ejercicio_musculo('Elevaciones con talones en máquina smith', gemelos).
...
ejercicio_musculo('Extensiones de muñeca con banda elástica', antebrazo).
ejercicio_musculo('Curl de muñeca con barra', antebrazo ).
ejercicio_musculo('Flexiones de muñeca con cuerda en polea alta', antebrazo).
ejercicio_musculo('Shrugs en máquina Smith', trapecio).
...
ejercicio_musculo('Elevaciones de piernas en suspensión', abdominales).
